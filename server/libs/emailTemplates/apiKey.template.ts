...
<body>
  <div class="container">
    ...
    <div class.content>
      ...
      <p class="p">We've sent you a API key to enable your access to <b>${Config.APP_NAME}</b> application.</p>
      <div class="otp-code">
        <div class="otp-container">
          <span>${apiKey}</span>
        </div>
      </div>
      <p class="p">This key enables you to interact with application. This is unique to you, please keep it safe.</p>
